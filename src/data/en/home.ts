export const langTxt = {
    HeroVideo_vidTag: "Your browser does not support the video tag.",
    HeroVideo_btnTxt: "Click and Try It",


    AboutUs_heading: "We Are",
    AboutUs_subHeading: "We design intelligent learning experiences",
    AboutUs_paragraphOne: `At CrearMedia, we believe learning should feel like a living
      experience that flows, connects, and transforms.`,
    AboutUs_paragraphTwo: `We deeply understand the challenges of each organization, and
      from there we build unique solutions centered on the user and
      designed to be applied, not just understood.`,
    AboutUs_paragraphThree: `We combine strategy, technology, storytelling, and instructional
      design to create experiences that feel natural, useful, and
      memorable.`,
    AboutUs_paragraphFour: `We are strategic partners at every stage of the process. We
      think alongside you. We design with intention.`,


    Features_heading: "Our Products and Services",
    Features_paragraphOne: "We drive the growth of your company with ",
    Features_paragraphTwo: "innovative training, immersive experiences and solutions adapted to your industry, through:",
    

    Success_heading: "Success stories that inspire and transform",
    Success_paragraphOne: `Explore how companies like yours have overcome challenges,
      boosted its growth and achieved its objectives with
      innovative learning strategies.`,
    Success_paragraphTwo: `Discover real stories of organizations that have enhanced their
      talent, optimized processes and generated a measurable impact
      thanks to tailor-made solutions.`,
    Success_paragraphThree: "Your company can also be the next success story.",
    Success_paragraphFour: "Ready to transform learning into a growth engine?",


    Marquees_heading: "These brands have already transformed learning into a competitive advantage",
    Marquees_btnTxt: "Want to be part?",


    CEOVideo_title: "Learning is not memorizing.",
    CEOVideo_subtitle: "It is feeling, connecting, transforming.",
}
...
export const testimonials = chunkArray(testimonialsList, 3);
